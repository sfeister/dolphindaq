...
from pva_ntndarray_signal import PvaNtNdArraySignal # local file, lets us keep metadata atomically attached to arrays
...
class DiodePVA(StandardReadable):
    ...
    def __init__(self, prefix: str = "pva://DIODE-DAQ:", name: str = "") -> None:
        ...
        # It is a custom helper Device, not an ophyd-async SignalR.
        self.trace = PvaNtNdArraySignal(prefix + "trace")
